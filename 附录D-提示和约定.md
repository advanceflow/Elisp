...
1.  [附录 D 提示和约定](#org7af4456)
    1.  [D.1 Emacs Lisp 编码约定](#orgdc241ab)
    2.  [D.2 键绑定约定](#org79a15a6)
    3.  [D.3 Emacs 编程技巧](#org5e6b918)
    4.  [D.4 快速编译代码的技巧](#org893c501)
    5.  [D.5 避免编译器警告的技巧](#org092d343)
    6.  [D.6 文档字符串提示](#org37bf1cd)
    7.  [D.7 撰写注释的技巧](#org923e472)
    8.  [D.8 Emacs 库的常规头文件](#org5a59521)
